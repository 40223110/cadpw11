...
'''
    ...
    def gear_width(self, horsepower=100, rpm=1000, ratio=4, toothtype=1, safetyfactor=2, material_serialno=1, npinion=18):
        ...
        return outstring
    #@+node:2014python.20141222004755.1743: *3* w12_1
    @cherrypy.expose
    ...
    '''
        return outstring
    #@+node:2014python.20141222004755.1747: *3* w12_2
    @cherrypy.expose
    ...
    '''
        return outstring
    #@+node:2014python.20141222004755.1749: *3* w12_3
    @cherrypy.expose
    ...
    '''
        return outstring
    #@+node:2014python.20141222004755.1751: *3* w12_4
    @cherrypy.expose
    ...
    '''
        return outstring
    #@+node:2014python.20141222004755.1957: *3* w12_5
    @cherrypy.expose
    ...
    '''
        return outstring
    #@+node:2014python.20141222004755.1959: *3* w12_6
    @cherrypy.expose
